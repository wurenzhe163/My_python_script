...
class SPANet(nn.Module):
    def __init__(self,in_channels=16,out_channels=12):
...
class Generator(nn.Module):
    def __init__(self,gpu_ids, in_channels=14,out_channels=12):
        super().__init__()
        self.gpu_ids = gpu_ids

        self.gen = nn.Sequential(OrderedDict([('gen', SPANet(in_channels=in_channels,out_channels=out_channels))]))
