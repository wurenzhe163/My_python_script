...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_dir',default=r'D:\Wrz\Dataset\test\train_image'
                        , type=str, required=False)
    parser.add_argument('--out_dir', default=r'D:\Wrz\Dataset\SpA-GAN\fitune_alpha'
                        ,type=str, required=False)
    parser.add_argument('--pretrained', default=r'D:\Wrz\SpA-GAN_for_cloud_removal-master\results\000006\models/gen_model_epoch_50.pth',
                        type=str, required=False)
