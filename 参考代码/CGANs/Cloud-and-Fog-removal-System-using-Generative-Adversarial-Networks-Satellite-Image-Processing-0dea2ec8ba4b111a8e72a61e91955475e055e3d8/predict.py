...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_dir',default=r'D:\Wrz\Dataset\test\train_image'
                        , type=str, required=False)
    parser.add_argument('--out_dir', default=r'D:\Wrz\Dataset\Cloud_fog\img2img'
                        ,type=str, required=False)
    parser.add_argument('--pretrained', default=r'D:/Wrz/Cloud-and-Fog-removal-System-using-Generative-Adversarial-Networks-Satellite-Image-Processing-0dea2ec8ba4b111a8e72a61e91955475e055e3d8/results/000004/models/gen_model_epoch_10.pth',
                        type=str, required=False)
